...
import static atmmanagementsystem_swing.DB_Handler.saveTransaction;
 ...
 * @author Dell
 */
public class withdrawlForm extends javax.swing.JFrame {

    /**
     * Creates new form withdrawlForm
     * @param accountNo
     */
    static String accountNo;
    public withdrawlForm(String accountNo) {
        withdrawlForm.accountNo = accountNo;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        withdrawlAmountField = new javax.swing.JTextField();
        ...
        withdrawlAmountField.setFont(new java.awt.Font("Segoe UI Emoji", 1, 24)); // NOI18N
        withdrawlAmountField.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        withdrawlAmountField.setOpaque(true);
        getContentPane().add(withdrawlAmountField, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 130, 280, 60));

        jLabel6.setFont(new java.awt.Font("Segoe UI Historic", 1, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel6.setText("Enter Amount to Withdraw:");
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        String amountStr = withdrawlAmountField.getText().trim();
        double amount;
        try {
            amount = Double.parseDouble(amountStr);
            boolean success = DB_Handler.updateBalanceAfterWithdrawal(accountNo, amount);
            if(success){
                DB_Handler.saveTransaction(accountNo,amount,"Withdrawl");
                new BalanceEnquiryForm(accountNo).setVisible(true);
                withdrawlAmountField.setText("");
                dispose();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(withdrawlForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField withdrawlAmountField;
